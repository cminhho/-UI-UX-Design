jQuery("#simulation")
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#t-a8aec9a1-253f-439c-9ba8-f308737cccb9 #t-Text_12": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#t-a8aec9a1-253f-439c-9ba8-f308737cccb9 #t-Text_11": {
                      "attributes": {
                        "border-top-width": "0px",
                        "border-top-style": "solid",
                        "border-top-color": "#C8C8C8",
  ...
  .on("click", ".t-a8aec9a1-253f-439c-9ba8-f308737cccb9 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
