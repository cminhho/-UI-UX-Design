jQuery("#simulation")
  .on("click", ".s-ac36a3b0-434c-4521-bb40-2feac7c6fe41 .click", function(event, data) {
    ...
    if(jFirer.is("#s-Flat-button")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-project_options")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("click", ".s-ac36a3b0-434c-4521-bb40-2feac7c6fe41 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
                ...
                "actions": [
                  {
                    ...
                    "parameter": [ {
                      "#s-ac36a3b0-434c-4521-bb40-2feac7c6fe41 #s-Label_13": {
                        "attributes": {
                          "font-size": "20.0pt",
                      ...
                      "#s-ac36a3b0-434c-4521-bb40-2feac7c6fe41 #s-Label_13 .valign": {
                        "attributes": {
                      ...
                      "#s-ac36a3b0-434c-4521-bb40-2feac7c6fe41 #s-Label_13 span": {
                        "attributes": {
                          "color": "#F77857",
                          "text-align": "left",
